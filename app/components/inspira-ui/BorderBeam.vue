...
const computedColorFrom = computed(() => colorMode.value === "dark" ? "#ffffff" : "#000000");
const computedColorTo = computed(() => colorMode.value === "dark" ? "#e6e6ff" : "#333333");
...
.border-beam {
  ...
  --color-from: v-bind(computedColorFrom);
  --color-to: v-bind(computedColorTo);
